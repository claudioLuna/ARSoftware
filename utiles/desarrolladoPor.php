...
<?php 
	include_once($_SERVER["DOCUMENT_ROOT"]."/Virtual/utiles/principal.php");
...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h1 class="page-header">
                          <div onclick="location = ('<?php echo $httpHostSitio?>modulos/back-end/administradores/principalAdministradorAR.php')"; style="height: 45px; width:680px;  max-width: 100%; background: #F2F2F2; background-image: url(<?php echo $httpHostSitio?>plantilla/imagenes/logotipoe.png);"></div>   
					    </h1>
	...
	<!--form-->
	<form enctype="multipart/form-data" method="post" id="formDesarrollado" name="formDesarrollado">
	
	<div class="jumbotron">
                    <h2>Desarrolado Por</h2>
                    Run & Debug (Rebolloso Leandro-Claudio Luna).
