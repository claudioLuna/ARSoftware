...
<br>
<br>
Entre la autoridad educativa provincial representada por el Sr/a: <B><?php echo $_datos['nombreDirector'];?> </B> DNI N° <B> <?php echo $_datos['dniDirector'];?></B>
en su carácter de Director de la Escuela <B> <?php echo $_datos['nombreEscuela'];?></B> Nº <B> <?php echo $_datos['numeroEscuela'];?></B> CUE: <B>
<?php echo $_datos['cueEscuela'];?> </B>
Sección de Supervisión <b><?php echo $_datos['seccionEscuela'];?> </b>de la ciudad de San Rafael Provincia de de Mendoza, con domicilio en <b><?php echo $_datos['domicilioEscuela'];?></b>
Nombre.................CUE............ Sección de Supervisión......de la ciudad de.............Provincia de Mendoza, con domicilio en...........................

En adelante “EL RECEPCIONISTA”, convienen por la presente acta la migración del/la alumno/a <b><?php echo $_alumnos['nombre'];?></b> CUIL Nº <b> <?php echo $_alumnos['cuil'];?></b>
...
correspondientes certificados de seguridad dejando de estar vinculada al servidor de la institución de origen.
 ...
 En prueba de conformidad se firman tres (3) ejemplares de un mismo tenor y a un solo efecto, por el CEDENTE y por el RECEPCIONISTA en la ciudad <B> <?php echo $_datos['ciudad'];?></B> Provincia de <B> <?php echo $_datos['ciudad'];?></B>,
 a los <b><?php echo date("d");?> </b> días del mes de <b><?php echo $mees;?> </b> de <b><?php echo date("Y");?></b>.
 
 <br>
 
 <div id="palabra" value="" style="border:1px solid #000000; width:140px;height:20px;margin:0 auto;padding:5px;background:#ffffff;font-Size:18px;" onclick="style.display='none',window.print();"><center>Imprimir</center></div>