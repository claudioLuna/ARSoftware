...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <?php include_once($docRootSitio."utiles/menuAlumnoAdministradorAR.php");?>    
            </div>
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        ...
                                        <div>Netbook en Servicio Tecnico</div>
                                    </div>
                                </div>
                            </div>
                            <a href="#">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-money fa-fw"></i>Servicio Tecnico</h3>
                            </div>
                            <div class="panel-body">
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                        <thead>
                                            <tr>
                                                <th>Nuemro de Ticket</th>
                                                <th>Dia</th>
                                                <th>Problema</th>
                                                <th>Lo que vamos a empezar a cobrar</th>
                                            </tr>
                                        </thead>
                                        <tbody>
        		
        		<?php for($i=1;$i<=count($_stecnicos);$i++){
		...
		?>
                                            ...
                                            <tr>
                                                <td><?php echo $_stecnicos[$i]['idreclamo'];?></td>
                                                <td><?php echo $_stecnicos[$i]['fecha'];?></td>
                                                <td><?php echo $_stecnicos[$i]['problema'];?></td>
                                                <td>$321.33</td>
                                            </tr>
            <?php }?>
                                        </tbody>
