...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Ver Mas Datos Alumno
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Ver Mas Datos Alumno
                            </li>
                        </ol>
                    </div>
                </div>
	...
	<?php if($mensaje){?>
		...
		<!--Curso-->
		<div class="form-group">
        <label>Curso:*</label><input class="form-control" readonly="readonly();"  name="direccion" value="<?php echo $_curso['nombre']?>">
        </div>
		<!--Turno-->
		<div class="form-group">
        <label>Turno:*</label><input class="form-control" readonly="readonly();"  name="direccion" value="<?php echo $_turno['nombre']?>">
        </div>
		<!--Nombre Padre-->
		<div class="form-group">
		...
		<!--Marca Netbook-->
		<div class="form-group">
        <label>Marca Netbook:*</label><input class="form-control" readonly="readonly();"  name="direccion" value="<?php echo $_marca['nombre']?>">
        </div>
		<!--Numero De Serie-->
		<div class="form-group">
