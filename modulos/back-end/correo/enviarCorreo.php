...
$_profesor = $ad1->listarAdministradorins2($profesor);
            ...
            <!-- Page Heading -->
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Enviar Correo
                            </li>
                        </ol>
                    </div>
                </div>
...
<form enctype="multipart/form-data" method="post" id="enviarMail" name="enviarMail">
<input type="hidden" name="bandera" value="1">	
<input type="hidden" name="nombreOrigen" value="<?php echo $profesor?>">
<input type="hidden" name="nombreDestino" value="<?php echo $profesor?>">	
