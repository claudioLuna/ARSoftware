...
if($_POST['bandera'] && $_POST['busqueda']!=""){
		$_GET = null;
	$_consultas = $consulta->listarNetbookCurso($offset,$limit,$campoOrder,$order,$_POST['busqueda'],$_POST['campoBusqueda']);
	}
	...
	if($_POST['campoBusqueda']){
		...
		$campoBusqueda['nombre'] = "Curso";
		$campoBusqueda['descripcion'] = "Curso";
	}
...
?> 
    ...
    <!--[if lt IE 9]>
        <script src="https://oss.maxcdn.com/lib s/html5shiv/3.7.0/html5shiv.js"></script>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
                  ...
                  </button><div onclick="location = ('<?php echo $httpHostSitio?>modulos/back-end/administradores/principalAdministradorAR.php')"; style="height: 52px; width:225px;  max-width: 100%; background: #FFFFFF; background-image: url(<?php echo $httpHostSitio?>plantilla/imagenes/logotipoe.png);"></div>   <a class="navbar-brand" href="<?php echo $httpHostSitio?>modulos/back-end/administradores/principalAdministradorAR.php">Administradores de Redes</a>
	            </div>
            <!--Menu-->
	...
	<li class="dropdown">
     ...
     <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Netbook por Curso
                            </li>
                        </ol>
